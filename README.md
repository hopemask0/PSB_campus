...
Этот проект представляет собой прототип образовательной платформы, реализовывающий пользовательский сценарий студента и преподавателя. Внутри курса предствлены различные функции для оптимизации учебного процесса: чат с преподавателем, отслеживание прогресса, выполенение домашних заданий.
## Установка
